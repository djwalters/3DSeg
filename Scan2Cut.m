...
function [Gc,brokbond]=Scan2Cut(Filepath,scale,firstim,imsize); %Filepath for images, scale (meters per pixel), image size as [1x3] array
%% Import Images
cd('/home/tonyl/BatchRun')

bw=BinStackImprt(Filepath,'%04d','.bmp',firstim,imsize); %Builds binary array from image stack
%bw=1;
