function RandomGeoCreate2(figflag, dims, mindiam, maxdiam, numspheres, fileout)
...
%   fileout: Determine whether to write out image stack
%       0 for no image stack export
%       1 for export image stack
%
% OUTPUTS:
